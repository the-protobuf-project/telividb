        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.CollectionService/CreateCollection",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("episteme.v1.CollectionService", "CreateCollection"),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.CollectionService/DescribeCollection",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "episteme.v1.CollectionService",
                        "DescribeCollection",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.CollectionService/ListCollections",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("episteme.v1.CollectionService", "ListCollections"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.CollectionService/DropCollection",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("episteme.v1.CollectionService", "DropCollection"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
*/
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/episteme.v1.CollectionService/DescribeCollection" => {
                    #[allow(non_camel_case_types)]
                    struct DescribeCollectionSvc<T: CollectionService>(pub Arc<T>);
                    impl<
                        T: CollectionService,
                    ...
                    for DescribeCollectionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CollectionService>::describe_collection(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/episteme.v1.CollectionService/DropCollection" => {
                    #[allow(non_camel_case_types)]
                    struct DropCollectionSvc<T: CollectionService>(pub Arc<T>);
                    impl<
                        T: CollectionService,
                    ...
                    for DropCollectionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CollectionService>::drop_collection(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "episteme.v1.CollectionService";
    impl<T> tonic::server::NamedService for CollectionServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod point_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
...
*/
    #[derive(Debug, Clone)]
    pub struct PointServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl PointServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> PointServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            PointServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn upsert(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.PointService/Upsert",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("episteme.v1.PointService", "Upsert"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.PointService/Get",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("episteme.v1.PointService", "Get"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn delete(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.PointService/Delete",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("episteme.v1.PointService", "Delete"));
            self.inner.unary(req, path, codec).await
        }
    }
}
/// Generated server implementations.
pub mod point_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with PointServiceServer.
    #[async_trait]
    pub trait PointService: std::marker::Send + std::marker::Sync + 'static {
        ///
        async fn upsert(
            &self,
...
*/
    #[derive(Debug)]
    pub struct PointServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for PointServiceServer<T>
    where
        T: PointService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/episteme.v1.PointService/Upsert" => {
                    #[allow(non_camel_case_types)]
                    struct UpsertSvc<T: PointService>(pub Arc<T>);
                    impl<
                        T: PointService,
                    ...
                    for UpsertSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PointService>::upsert(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/episteme.v1.PointService/Get" => {
                    #[allow(non_camel_case_types)]
                    struct GetSvc<T: PointService>(pub Arc<T>);
                    impl<T: PointService> tonic::server::UnaryService<super::GetRequest>
                    for GetSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PointService>::get(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/episteme.v1.PointService/Delete" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSvc<T: PointService>(pub Arc<T>);
                    impl<
                        T: PointService,
                    ...
                    for DeleteSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PointService>::delete(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for PointServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "episteme.v1.PointService";
    impl<T> tonic::server::NamedService for PointServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
*/
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn search(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.SearchService/Search",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("episteme.v1.SearchService", "Search"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.v1.SearchService/BatchSearch",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("episteme.v1.SearchService", "BatchSearch"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
*/
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/episteme.v1.SearchService/BatchSearch" => {
                    #[allow(non_camel_case_types)]
                    struct BatchSearchSvc<T: SearchService>(pub Arc<T>);
                    impl<
                        T: SearchService,
                    ...
                    for BatchSearchSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SearchService>::batch_search(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "episteme.v1.SearchService";
