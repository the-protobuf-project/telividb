...
*/
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("episteme.point.v1.Points", "BatchCreatePoints"),
                );
            self.inner.unary(req, path, codec).await
        }
...
*/
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.point.v1.Points/BatchGetPoints",
            );
            let mut req = request.into_request();
            req.extensions_mut()
...
*/
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/episteme.point.v1.Points/BatchDeletePoints",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("episteme.point.v1.Points", "BatchDeletePoints"),
                );
            self.inner.unary(req, path, codec).await
        }
...
*/
    ...
    pub const SERVICE_NAME: &str = "episteme.point.v1.Points";
