...
pub const SEARCH_RESULTS: &str = "telividb_search_results_returned";

/// Counter. Result sets that were not complete — labelled by reason.
pub const SEARCH_INCOMPLETE: &str = "telividb_search_incomplete_total";
...
pub const SEARCH_RECALL: &str = "telividb_search_recall_at_k";

// --- write path -------------------------------------------------------------

/// Histogram. Time to flush and fsync one group commit — the write path's real cost.
pub const WAL_COMMIT_DURATION: &str = "telividb_wal_commit_duration_seconds";
/// Histogram. Records per group commit. Falling toward one means batching has stopped working.
pub const WAL_COMMIT_RECORDS: &str = "telividb_wal_commit_records";
/// Counter. Bytes appended to the log.
pub const WAL_BYTES: &str = "telividb_wal_bytes_total";
...
pub const WAL_TORN_RECOVERIES: &str = "telividb_wal_torn_recoveries_total";

/// Histogram. Time to seal a buffer into an immutable segment.
pub const SEGMENT_SEAL_DURATION: &str = "telividb_segment_seal_duration_seconds";
/// Histogram. Time to build an index over a sealed segment.
pub const INDEX_BUILD_DURATION: &str = "telividb_index_build_duration_seconds";
/// Histogram. Time to publish a new manifest generation.
pub const MANIFEST_SWAP_DURATION: &str = "telividb_manifest_swap_duration_seconds";
/// Histogram. Time to merge segments and drop tombstoned rows.
pub const COMPACTION_DURATION: &str = "telividb_compaction_duration_seconds";

// --- state ------------------------------------------------------------------

/// Gauge. Segments named by the current manifest.
pub const SEGMENTS_LIVE: &str = "telividb_segments_live";
/// Gauge. Rows visible to readers.
pub const ROWS_LIVE: &str = "telividb_rows_live";
...
pub const ROWS_TOMBSTONED: &str = "telividb_rows_tombstoned";

// --- embedding --------------------------------------------------------------

/// Histogram. Time to embed one batch.
pub const EMBED_DURATION: &str = "telividb_embed_duration_seconds";
/// Histogram. Inputs per embedding batch.
pub const EMBED_BATCH_SIZE: &str = "telividb_embed_batch_size";

// --- policy -----------------------------------------------------------------

/// Counter. Requests denied, by action. A spike is either an attack or a
/// misconfigured grant, and both want to be visible.
pub const POLICY_DENIED: &str = "telividb_policy_denied_total";
...
pub const POLICY_RESOLVE_DURATION: &str = "telividb_policy_resolve_duration_seconds";

// --- bulk jobs --------------------------------------------------------------

/// Counter. Bulk job records, labelled by outcome.
pub const JOB_RECORDS: &str = "telividb_job_records_total";
/// Histogram. Bulk job wall-clock duration.
pub const JOB_DURATION: &str = "telividb_job_duration_seconds";
