...
impl<'a> Model<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Model::VT_NAME, None)}
  }
  ...
  pub fn digest(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Model::VT_DIGEST, None)}
  }
  ...
  pub fn architecture(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Model::VT_ARCHITECTURE, None)}
  }
  ...
  pub fn context_length(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(Model::VT_CONTEXT_LENGTH, Some(0)).unwrap()}
  }
  ...
  pub fn quantization(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Model::VT_QUANTIZATION, None)}
  }
  ...
  pub fn resident(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(Model::VT_RESIDENT, Some(false)).unwrap()}
  }
  ...
  pub fn resident_bytes(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(Model::VT_RESIDENT_BYTES, Some(0)).unwrap()}
  }
  ...
  pub fn create_time(&self) -> Option<&'a super::super::super::buffers::wellknown::Timestamp> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<super::super::super::buffers::wellknown::Timestamp>(Model::VT_CREATE_TIME, None)}
  }
  ...
  pub fn etag(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Model::VT_ETAG, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ModelBuilder<'a, 'b, A> {
  ...
  pub fn add_digest(&mut self, digest: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Model::VT_DIGEST, digest);
  }
  #[inline]
  pub fn add_architecture(&mut self, architecture: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Model::VT_ARCHITECTURE, architecture);
  }
  #[inline]
  pub fn add_dimensions(&mut self, dimensions: i32) {
    self.fbb_.push_slot::<i32>(Model::VT_DIMENSIONS, dimensions, 0);
  }
  #[inline]
  pub fn add_context_length(&mut self, context_length: i32) {
    self.fbb_.push_slot::<i32>(Model::VT_CONTEXT_LENGTH, context_length, 0);
  }
  #[inline]
  pub fn add_quantization(&mut self, quantization: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Model::VT_QUANTIZATION, quantization);
  }
  #[inline]
  pub fn add_resident(&mut self, resident: bool) {
    self.fbb_.push_slot::<bool>(Model::VT_RESIDENT, resident, false);
  }
  #[inline]
  pub fn add_resident_bytes(&mut self, resident_bytes: i64) {
    self.fbb_.push_slot::<i64>(Model::VT_RESIDENT_BYTES, resident_bytes, 0);
  }
  #[inline]
  pub fn add_create_time(&mut self, create_time: &super::super::super::buffers::wellknown::Timestamp) {
    self.fbb_.push_slot_always::<&super::super::super::buffers::wellknown::Timestamp>(Model::VT_CREATE_TIME, create_time);
  }
  #[inline]
  pub fn add_etag(&mut self, etag: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Model::VT_ETAG, etag);
  }
  #[inline]
