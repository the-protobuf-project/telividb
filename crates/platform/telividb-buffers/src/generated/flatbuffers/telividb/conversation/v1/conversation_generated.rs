        ...
        pub mod v_1 {
            ...
            impl<'a> Conversation<'a> {
                ...
                pub fn suppressed(&self) -> bool {
                    ...
                    unsafe {
                        self._tab
                            .get::<bool>(Conversation::VT_SUPPRESSED, Some(false))
                            .unwrap()
                    }
                }
                ...
                pub fn message_count(&self) -> i32 {
                    ...
                    unsafe {
                        self._tab
                            .get::<i32>(Conversation::VT_MESSAGE_COUNT, Some(0))
                            .unwrap()
                    }
                }
            ...
            impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ConversationBuilder<'a, 'b, A> {
                ...
                pub fn add_suppressed(&mut self, suppressed: bool) {
                    self.fbb_
                        .push_slot::<bool>(Conversation::VT_SUPPRESSED, suppressed, false);
                }
                #[inline]
                pub fn add_message_count(&mut self, message_count: i32) {
                    self.fbb_
                        .push_slot::<i32>(Conversation::VT_MESSAGE_COUNT, message_count, 0);
                }
                #[inline]
