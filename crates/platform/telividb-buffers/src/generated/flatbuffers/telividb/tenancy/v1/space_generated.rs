        ...
        pub mod v_1 {
            ...
            impl<'a> Space<'a> {
                ...
                pub fn name(&self) -> Option<&'a str> {
                    ...
                    unsafe {
                        self._tab
                            .get::<::flatbuffers::ForwardsUOffset<&str>>(Space::VT_NAME, None)
                    }
                }
                ...
                pub fn protection(&self) -> Protection {
                    ...
                    unsafe {
                        self._tab
                            .get::<Protection>(
                                Space::VT_PROTECTION,
                                Some(Protection::PROTECTION_UNSPECIFIED),
                            )
                            .unwrap()
                    }
                }
                ...
                pub fn locked(&self) -> bool {
                    ...
                    unsafe {
                        self._tab
                            .get::<bool>(Space::VT_LOCKED, Some(false))
                            .unwrap()
                    }
                }
                ...
                pub fn etag(&self) -> Option<&'a str> {
                    ...
                    unsafe {
                        self._tab
                            .get::<::flatbuffers::ForwardsUOffset<&str>>(Space::VT_ETAG, None)
                    }
                }
            }
            ...
            impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SpaceBuilder<'a, 'b, A> {
                ...
                pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b str>) {
                    self.fbb_
                        .push_slot_always::<::flatbuffers::WIPOffset<_>>(Space::VT_NAME, name);
                }
                #[inline]
                ...
                pub fn add_protection(&mut self, protection: Protection) {
                    self.fbb_.push_slot::<Protection>(
                        Space::VT_PROTECTION,
                        protection,
                        Protection::PROTECTION_UNSPECIFIED,
                    );
                ...
                pub fn add_etag(&mut self, etag: ::flatbuffers::WIPOffset<&'b str>) {
                    self.fbb_
                        .push_slot_always::<::flatbuffers::WIPOffset<_>>(Space::VT_ETAG, etag);
                }
                #[inline]
                pub fn new(
                ...
                pub fn finish(self) -> ::flatbuffers::WIPOffset<Space<'a>> {
                    ...
                    self.fbb_
                        .required(o, Space::VT_DISPLAY_NAME, "display_name");
