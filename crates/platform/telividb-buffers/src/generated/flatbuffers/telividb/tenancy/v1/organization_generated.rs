...
impl<'a> Organization<'a> {
  ...
  pub fn display_name(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Organization::VT_DISPLAY_NAME, None).unwrap()}
  }
  ...
  pub fn project_count(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(Organization::VT_PROJECT_COUNT, Some(0)).unwrap()}
  }
  ...
  pub fn space_count(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(Organization::VT_SPACE_COUNT, Some(0)).unwrap()}
  }
  ...
  pub fn create_time(&self) -> Option<&'a super::super::super::buffers::wellknown::Timestamp> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<super::super::super::buffers::wellknown::Timestamp>(Organization::VT_CREATE_TIME, None)}
  }
  ...
  pub fn update_time(&self) -> Option<&'a super::super::super::buffers::wellknown::Timestamp> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<super::super::super::buffers::wellknown::Timestamp>(Organization::VT_UPDATE_TIME, None)}
  }
  ...
  pub fn delete_time(&self) -> Option<&'a super::super::super::buffers::wellknown::Timestamp> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<super::super::super::buffers::wellknown::Timestamp>(Organization::VT_DELETE_TIME, None)}
  }
  ...
  pub fn expire_time(&self) -> Option<&'a super::super::super::buffers::wellknown::Timestamp> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<super::super::super::buffers::wellknown::Timestamp>(Organization::VT_EXPIRE_TIME, None)}
  }
  ...
  pub fn etag(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Organization::VT_ETAG, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> OrganizationBuilder<'a, 'b, A> {
  ...
  pub fn add_display_name(&mut self, display_name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Organization::VT_DISPLAY_NAME, display_name);
  }
  #[inline]
  pub fn add_project_count(&mut self, project_count: i32) {
    self.fbb_.push_slot::<i32>(Organization::VT_PROJECT_COUNT, project_count, 0);
  }
  #[inline]
  pub fn add_space_count(&mut self, space_count: i32) {
    self.fbb_.push_slot::<i32>(Organization::VT_SPACE_COUNT, space_count, 0);
  }
  #[inline]
  pub fn add_create_time(&mut self, create_time: &super::super::super::buffers::wellknown::Timestamp) {
    self.fbb_.push_slot_always::<&super::super::super::buffers::wellknown::Timestamp>(Organization::VT_CREATE_TIME, create_time);
  }
  #[inline]
  pub fn add_update_time(&mut self, update_time: &super::super::super::buffers::wellknown::Timestamp) {
    self.fbb_.push_slot_always::<&super::super::super::buffers::wellknown::Timestamp>(Organization::VT_UPDATE_TIME, update_time);
  }
  #[inline]
  pub fn add_delete_time(&mut self, delete_time: &super::super::super::buffers::wellknown::Timestamp) {
    self.fbb_.push_slot_always::<&super::super::super::buffers::wellknown::Timestamp>(Organization::VT_DELETE_TIME, delete_time);
  }
  #[inline]
  pub fn add_expire_time(&mut self, expire_time: &super::super::super::buffers::wellknown::Timestamp) {
    self.fbb_.push_slot_always::<&super::super::super::buffers::wellknown::Timestamp>(Organization::VT_EXPIRE_TIME, expire_time);
  }
  #[inline]
  pub fn add_etag(&mut self, etag: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Organization::VT_ETAG, etag);
  }
  #[inline]
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<Organization<'a>> {
    ...
    self.fbb_.required(o, Organization::VT_DISPLAY_NAME,"display_name");
