...
impl ::capnp::introspect::Introspect for Level {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&level::ARENA, level::get_annotation_types)).into() }
}
impl ::core::convert::From<Level> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: Level) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&level::ARENA, level::get_annotation_types).into()).into() }
}
...
pub mod summary {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_level(self) -> ::core::result::Result<crate::summary_capnp::Level,::capnp::NotInSchema> {
        ...
        #[inline]
        pub fn get_coverage_end_time(self) -> ::capnp::Result<crate::wellknown_capnp::timestamp::Reader<'a>> {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn get_coverage_end_time(self) -> ::capnp::Result<crate::wellknown_capnp::timestamp::Builder<'a>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(3), ::core::option::Option::None)
        }
        #[inline]
        pub fn set_coverage_end_time(&mut self, value: crate::wellknown_capnp::timestamp::Reader<'_>) -> ::capnp::Result<()> {
        ...
        #[inline]
        pub fn set_inherited_protection(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
