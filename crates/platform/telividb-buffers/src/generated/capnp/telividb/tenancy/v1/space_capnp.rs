...
impl ::capnp::introspect::Introspect for Protection {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&protection::ARENA, protection::get_annotation_types)).into() }
}
impl ::core::convert::From<Protection> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: Protection) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&protection::ARENA, protection::get_annotation_types).into()).into() }
}
impl ::core::convert::TryFrom<u16> for Protection {
    type Error = ::capnp::NotInSchema;
    fn try_from(value: u16) -> ::core::result::Result<Self, <Protection as ::core::convert::TryFrom<u16>>::Error> {
        match value {
...
impl From<Protection> for u16 {
    #[inline]
    fn from(x: Protection) -> u16 { x as u16 }
}
...
pub mod space {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_protection(self) -> ::core::result::Result<crate::space_capnp::Protection,::capnp::NotInSchema> {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_projects(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text_list::Owned>) -> ::capnp::Result<()> {
