...
pub mod search_points_request {
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn set_query(
            &mut self,
            value: crate::point_capnp::vector::Reader<'_>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
...
pub mod search_points_response {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_results(
            ...
            ::capnp::struct_list::Reader<'a, crate::point_search_capnp::search_result::Owned>,
        > {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        pub fn get_stats(
            self,
        ) -> ::capnp::Result<crate::point_search_capnp::search_stats::Reader<'a>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(3),
                ::core::option::Option::None,
            )
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_results(
            ...
            ::capnp::struct_list::Builder<'a, crate::point_search_capnp::search_result::Owned>,
        > {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
                self.builder.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        pub fn set_results(
            ...
            value: ::capnp::struct_list::Reader<
                '_,
                crate::point_search_capnp::search_result::Owned,
            >,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
                self.builder.reborrow().get_pointer_field(0),
        ...
        pub fn get_stats(
            self,
        ) -> ::capnp::Result<crate::point_search_capnp::search_stats::Builder<'a>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
                self.builder.get_pointer_field(3),
                ::core::option::Option::None,
            )
        ...
        pub fn set_stats(
            &mut self,
            value: crate::point_search_capnp::search_stats::Reader<'_>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
                self.builder.reborrow().get_pointer_field(3),
                value,
