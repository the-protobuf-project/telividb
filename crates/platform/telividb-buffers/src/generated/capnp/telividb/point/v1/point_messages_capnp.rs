...
pub mod create_point_request {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_point_id(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
...
pub mod list_points_response {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_points(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::point_capnp::point::Owned>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
        }
        #[inline]
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn get_points(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::point_capnp::point::Owned>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
        }
        #[inline]
        pub fn set_points(&mut self, value: ::capnp::struct_list::Reader<'_,crate::point_capnp::point::Owned>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
        }
        #[inline]
        pub fn init_points(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::point_capnp::point::Owned> {
...
pub mod batch_create_points_request {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_requests(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::point_messages_capnp::create_point_request::Owned>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
        }
        #[inline]
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn get_requests(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::point_messages_capnp::create_point_request::Owned>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
        }
        #[inline]
        pub fn set_requests(&mut self, value: ::capnp::struct_list::Reader<'_,crate::point_messages_capnp::create_point_request::Owned>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
        }
        #[inline]
        pub fn init_requests(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::point_messages_capnp::create_point_request::Owned> {
            ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(1), size)
        }
        #[inline]
        pub fn has_requests(&self) -> bool {
    ...
    mod _private {
        ...
        pub(crate) fn get_field_types(index: u16) -> ::capnp::introspect::Type {
            match index {
                0 => <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect(),
                1 => <::capnp::struct_list::Owned<crate::point_messages_capnp::create_point_request::Owned> as ::capnp::introspect::Introspect>::introspect(),
                _ => ::capnp::introspect::panic_invalid_field_index(index),
            }
        }
        pub(crate) fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
...
pub mod batch_get_points_request {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_names(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text_list::Owned>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
        }
        #[inline]
