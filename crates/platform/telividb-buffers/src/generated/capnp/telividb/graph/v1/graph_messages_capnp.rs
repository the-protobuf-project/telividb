    ...
    mod _private {
        ...
        pub(crate) fn get_field_types(index: u16) -> ::capnp::introspect::Type {
            match index {
                ...
                2 => {
                    <crate::edge_capnp::edge::Owned as ::capnp::introspect::Introspect>::introspect(
                    )
                }
...
pub mod list_edges_response {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_edges(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Reader<'a, crate::edge_capnp::edge::Owned>>
        {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(0),
                ::core::option::Option::None,
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_edges(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Builder<'a, crate::edge_capnp::edge::Owned>>
        {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
                self.builder.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        pub fn set_edges(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::edge_capnp::edge::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
                self.builder.reborrow().get_pointer_field(0),
                value,
        ...
        pub fn init_edges(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::edge_capnp::edge::Owned> {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_requests(
            ...
            ::capnp::struct_list::Reader<
                'a,
                crate::graph_messages_capnp::create_edge_request::Owned,
            >,
        > {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(1),
...
pub mod list_edge_types_response {
    ...
    impl<'a> Reader<'a> {
        ...
        #[inline]
        pub fn get_edge_types(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Reader<'a, crate::edge_capnp::edge_type::Owned>>
        {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(0),
                ::core::option::Option::None,
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_edge_types(
            self,
        ) -> ::capnp::Result<::capnp::struct_list::Builder<'a, crate::edge_capnp::edge_type::Owned>>
        {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
                self.builder.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        pub fn set_edge_types(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::edge_capnp::edge_type::Owned>,
        ) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(
                self.builder.reborrow().get_pointer_field(0),
                value,
        ...
        #[inline]
        pub fn init_edge_types(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::edge_capnp::edge_type::Owned> {
            ::capnp::traits::FromPointerBuilder::init_pointer(
                self.builder.get_pointer_field(0),
                size,
            )
