...
impl ::core::convert::TryFrom<u16> for BudgetSource {
    ...
    fn try_from(
        value: u16,
    ) -> ::core::result::Result<Self, <BudgetSource as ::core::convert::TryFrom<u16>>::Error> {
        match value {
...
pub mod system {
    ...
    impl<'a> Reader<'a> {
        ...
        #[inline]
        pub fn get_budget_source(
            self,
        ) -> ::core::result::Result<crate::system_capnp::BudgetSource, ::capnp::NotInSchema>
        {
