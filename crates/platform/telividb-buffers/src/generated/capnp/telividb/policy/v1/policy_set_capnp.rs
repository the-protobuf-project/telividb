...
impl ::capnp::introspect::Introspect for Effect {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&effect::ARENA, effect::get_annotation_types)).into() }
}
impl ::core::convert::From<Effect> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: Effect) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&effect::ARENA, effect::get_annotation_types).into()).into() }
}
impl ::core::convert::TryFrom<u16> for Effect {
    type Error = ::capnp::NotInSchema;
    fn try_from(value: u16) -> ::core::result::Result<Self, <Effect as ::core::convert::TryFrom<u16>>::Error> {
        match value {
...
pub mod policy_set {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_user_groups(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text_list::Owned>) -> ::capnp::Result<()> {
...
pub mod decision {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_effect(self) -> ::core::result::Result<crate::policy_set_capnp::Effect,::capnp::NotInSchema> {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_row_predicate(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false).unwrap()
        }
        #[inline]
        ...
        #[inline]
        pub fn set_field_mask(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text_list::Owned>) -> ::capnp::Result<()> {
    ...
    mod _private {
        ...
        pub(crate) fn get_field_types(index: u16) -> ::capnp::introspect::Type {
            match index {
                0 => <crate::policy_set_capnp::Effect as ::capnp::introspect::Introspect>::introspect(),
                1 => <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect(),
