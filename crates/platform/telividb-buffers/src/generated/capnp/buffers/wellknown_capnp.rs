...
pub mod timestamp {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
            ...
            ::capnp::word(107, 78, 118, 174, 136, 113, 191, 231),
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(243, 1, 0, 0, 67, 2, 0, 0),
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(98, 117, 102, 102, 101, 114, 115, 47),
            ::capnp::word(119, 101, 108, 108, 107, 110, 111, 119),
            ::capnp::word(110, 46, 99, 97, 112, 110, 112, 58),
            ::capnp::word(84, 105, 109, 101, 115, 116, 97, 109),
        ...
        pub(crate) const TYPE_ID: u64 = 0xd4ef_d046_9293_94b8;
    }
}
...
pub mod duration {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
            ...
            ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(124, 2, 0, 0, 203, 2, 0, 0),
            ...
            ::capnp::word(119, 101, 108, 108, 107, 110, 111, 119),
            ::capnp::word(110, 46, 99, 97, 112, 110, 112, 58),
            ::capnp::word(68, 117, 114, 97, 116, 105, 111, 110),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
            ::capnp::word(8, 0, 0, 0, 3, 0, 4, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT: &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME: &[u16] = &[1, 0];
        pub(crate) const TYPE_ID: u64 = 0xa744_efa4_4d2e_99a1;
    }
}
