...
*/
        pub async fn move_conversation(
            ...
            tonic::Response<super::MoveConversationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
*/
        pub async fn list_tool_invocations(
            ...
            tonic::Response<super::ListToolInvocationsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
                ...
                "/telividb.conversation.v1.Conversations/CreateConversation" => {
                    ...
                    for CreateConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Conversations>::create_conversation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/telividb.conversation.v1.Conversations/GetConversation" => {
                    ...
                    for GetConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::get_conversation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/telividb.conversation.v1.Conversations/ListConversations" => {
                    ...
                    for ListConversationsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::list_conversations(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/telividb.conversation.v1.Conversations/MoveConversation" => {
                    ...
                    for MoveConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::move_conversation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/telividb.conversation.v1.Conversations/SuppressConversation" => {
                    ...
                    for SuppressConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::suppress_conversation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/telividb.conversation.v1.Conversations/UnsuppressConversation" => {
                    ...
                    for UnsuppressConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::unsuppress_conversation(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/telividb.conversation.v1.Conversations/DeleteConversation" => {
                    ...
                    for DeleteConversationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::delete_conversation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/telividb.conversation.v1.Conversations/GetToolInvocation" => {
                    ...
                    for GetToolInvocationSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::get_tool_invocation(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/telividb.conversation.v1.Conversations/ListToolInvocations" => {
                    ...
                    for ListToolInvocationsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Conversations>::list_tool_invocations(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
