...
pub mod policy_client {
    ...
    impl PolicyClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> PolicyClient<InterceptedService<T, F>>
        where
...
pub mod policy_server {
    ...
    #[async_trait]
    pub trait Policy: std::marker::Send + std::marker::Sync + 'static {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for PolicyServer<T>
    where
        T: Policy,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/telividb.policy.v1.Policy/CreatePolicySet" => {
                        ...
                        for CreatePolicySetSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Policy>::create_policy_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = CreatePolicySetSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                ...
                "/telividb.policy.v1.Policy/GetPolicySet" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetPolicySetSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/telividb.policy.v1.Policy/ListPolicySets" => {
                    ...
                    impl<T: Policy> tonic::server::UnaryService<super::ListPolicySetsRequest> for ListPolicySetsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Policy>::list_policy_sets(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListPolicySetsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/telividb.policy.v1.Policy/DeletePolicySet" => {
                        ...
                        for DeletePolicySetSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Policy>::delete_policy_set(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeletePolicySetSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/telividb.policy.v1.Policy/EvaluatePolicy" => {
                    ...
                    impl<T: Policy> tonic::server::UnaryService<super::EvaluatePolicyRequest> for EvaluatePolicySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Policy>::evaluate_policy(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for PolicyServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "telividb.policy.v1.Policy";
    impl<T> tonic::server::NamedService for PolicyServer<T> {
