...
use telividb_buffers::protobuf::collection::v1::{Collection, CreateCollectionRequest, Metric, VectorField};
    ...
    let outcome = client
        .create_collection(CreateCollectionRequest {
            ...
            collection: Some(Collection {
                ...
                descriptor_set: telividb_buffers::protobuf::FILE_DESCRIPTOR_SET.to_vec().into(),
