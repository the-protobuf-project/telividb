...
pub(super) fn candle_err(e: candle_core::Error) -> telividb_core::Error {
...
pub(super) fn metric_name(metric: Metric) -> &'static str {
    match metric {
        Metric::Dot => "dot",
        Metric::L2 => "l2",
